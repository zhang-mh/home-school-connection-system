	...
	i++;
     ...
     %>
                          <tr bgcolor="#E1F3F4" height="60" valign="middle">
                            <td width="13%" align="center" bgcolor="#FFFFFF"><a href="bbslist.jsp?bk=<%=map.get("mingcheng") %>"><img src="bbs/1.gif" border="0"></a> </td>
                            <td width="37%" align="left" bgcolor="#FFFFFF"><a href="bbslist.jsp?bk=<%=map.get("mingcheng") %>">&nbsp;<%=map.get("mingcheng") %>&nbsp;&gt;&gt;</a> </td>
                            <td width="27%" align="left" bgcolor="#FFFFFF">共有
                             
							  <%=new CommDAO().getwzs((String)map.get("mingcheng"))%>
                              篇文章 </td>

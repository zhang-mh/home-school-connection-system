...
<body style="margin: 0; border: 0;">
        ...
        <div class="main" id="menua">
			...
			<h3 menuid="13"  id="menu13" onclick="showsubmenu(13)" toggleGroup="on" class="menutitle"><div class="bt13"><span>班级管理</span></div></h3>
				<ul id="submenu13">
					<li><a href="banjixinxi_add.jsp" target="frmright">班级添加</a></li>
					<li><a href="banjixinxi_list.jsp" target="frmright">班级查询</a></li>
				</ul>
            
			<h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2"><span>教师信息管理</span></div></h3>
				<ul id="submenu2">
					<li><a href="jiaoshixinxi_add.jsp" target="frmright">教师信息添加</a></li>
					<li><a href="jiaoshixinxi_list.jsp" target="frmright">教师信息查询</a></li>
				</ul>
			
			
			<h3 menuid="4"  id="menu4" onclick="showsubmenu(4)" toggleGroup="on" class="menutitle"><div class="bt4"><span>论坛管理</span></div></h3>
				<ul id="submenu4">
			...
			<h3 menuid="5"  id="menu5" onclick="showsubmenu(5)" togglegroup="on" class="menutitle"><div class="bt5"><span>课程管理</span></div></h3>
				<ul id="submenu5">
					<li><a href="kechengxinxi_add.jsp" target="frmright">课程添加</a></li>
					<li><a href="kechengxinxi_list.jsp" target="frmright">课程查询</a></li>
				</ul>
			...
			<h3 menuid="18"  id="menu18" onclick="showsubmenu(18)" toggleGroup="on" class="menutitle"><div class="bt8"><span>系统管理</span></div></h3>
				<ul id="submenu18">
					...
					<li><a href="dx.jsp?lb=通知公告" target="frmright">通知公告设置</a></li>
				</ul>
...
<!--
班级信息管理
banjixinxi_add 班级信息添加
banjixinxi_list 班级信息查询

教师信息管理
jiaoshixinxi_add 教师信息添加
jiaoshixinxi_list 教师信息查询

家长信息管理
jiachangxinxi_add 家长信息添加
jiachangxinxi_list 家长信息查询

班级相册管理
banjixiangce_add 班级相册添加
banjixiangce_list 班级相册查询

学生成绩管理
xueshengchengji_add 学生成绩添加
xueshengchengji_list 学生成绩查询

请假申请管理
qingjiashenqing_add 请假申请添加
qingjiashenqing_list 请假申请查询

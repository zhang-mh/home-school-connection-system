...
<%
	...
	HashMap mqt = new CommDAO().getmap(id,"jiaoshixinxi");
...
<div class="row nospace">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>教师号：</td><td width='39%'><%=mqt.get("jiaoshihao")%></td><td  rowspan=7 align=center><a href=<%=mqt.get("zhaopian")%> target=_blank><img src=<%=mqt.get("zhaopian")%> width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>密码：</td><td width='39%'>******</td></tr><tr>         <td width='11%' height=44>教师姓名：</td><td width='39%'><%=mqt.get("jiaoshixingming")%></td></tr><tr>         <td width='11%' height=44>性别：</td><td width='39%'><%=mqt.get("xingbie")%></td></tr><tr>         <td width='11%' height=44>级别：</td><td width='39%'><%=mqt.get("jibie")%></td></tr><tr>         <td width='11%' height=44>手机：</td><td width='39%'><%=mqt.get("shouji")%></td></tr><tr>         <td width='11%' height=44>邮箱：</td><td width='39%'><%=mqt.get("youxiang")%></td></tr><tr>                           <td width='11%' height=100  >教师简介：</td><td width='39%' colspan=2 height=100 ><%=mqt.get("jiaoshijianjie")%></td></tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" /> <!--jixaaxnnxiu--></td></tr>

...
<html>
  ...
  <form name="form1" id="form1" method="post" action="">
   搜索:  课程名称：<input name="kechengmingcheng" type="text" id="kechengmingcheng" style='border:solid 1px #000000; color:#666666' size="12" />
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="kechengxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="kechengxinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>

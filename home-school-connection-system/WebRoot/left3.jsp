...
<body style="margin: 0; border: 0;">
        ...
        <div class="main" id="menua">
			...
			<h3 menuid="1"  id="menu1" onclick="showsubmenu(1)" toggleGroup="on" class="menutitle"><div class="bt1"><span>个人资料管理</span></div></h3>
				<ul id="submenu1">
					<li><a href="jiachangxinxi_updt2.jsp" target="frmright">家长资料管理</a></li>
				</ul>

            <h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2"><span>请假申请</span></div></h3>
				<ul id="submenu2">
					<li><a href="qingjiashenqing_list2.jsp" target="frmright">请假申请</a></li>
				</ul>
            <h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2"><span>学生成绩</span></div></h3>
				<ul id="submenu2">
					<li><a href="xueshengchengji_list3.jsp" target="frmright">学生成绩</a></li>
				</ul>

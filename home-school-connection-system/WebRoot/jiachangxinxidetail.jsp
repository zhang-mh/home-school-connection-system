...
<%
	...
	HashMap mqt = new CommDAO().getmap(id,"jiachangxinxi");
...
<h2 class="bottom-0 page-title">家长信息</h2>
</div>
</div>
...
<div class="row nospace">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>家长账号：</td><td width='39%'><%=mqt.get("jiachangzhanghao")%></td><td  rowspan=10 align=center><a href=<%=mqt.get("xueshengzhaopian")%> target=_blank><img src=<%=mqt.get("xueshengzhaopian")%> width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>密码：</td><td width='39%'>******</td></tr><tr>         <td width='11%' height=44>家长姓名：</td><td width='39%'><%=mqt.get("jiachangxingming")%></td></tr><tr>         <td width='11%' height=44>家长职业：</td><td width='39%'><%=mqt.get("jiachangzhiye")%></td></tr><tr>         <td width='11%' height=44>学生学号：</td><td width='39%'><%=mqt.get("xueshengxuehao")%></td></tr><tr>         <td width='11%' height=44>学生姓名：</td><td width='39%'><%=mqt.get("xueshengxingming")%></td></tr><tr>         <td width='11%' height=44>班级：</td><td width='39%'><%=mqt.get("banji")%></td></tr><tr>         <td width='11%' height=44>家长手机：</td><td width='39%'><%=mqt.get("jiachangshouji")%></td></tr><tr>         <td width='11%' height=44>家长邮箱：</td><td width='39%'><%=mqt.get("jiachangyouxiang")%></td></tr><tr>                  <td width='11%' height=44>教师号：</td><td width='39%'><%=mqt.get("jiaoshihao")%></td></tr><tr>                  <td width='11%' height=100  >备注：</td><td width='39%' colspan=2 height=100 ><%=mqt.get("beizhu")%></td></tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" /> <input type="button" name="jiachangxinxixueshengchengji" value="学生成绩" onclick="javascript:location.href='xueshengchengjiadd.jsp?id=<%=id%>';"> <!--jixaaxnnxiu--></td></tr>
